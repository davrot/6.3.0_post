...
export const LLM_COMPILE_FIX_EVENT = 'overleaf-llm-compile-fix-changed' // [VI] named export: pdf-llm-compile-fix-card imports it as a named binding (was default-object-only → undefined at runtime)
