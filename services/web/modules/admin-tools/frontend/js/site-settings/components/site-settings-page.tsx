...
export default function SiteSettingsPage() {
  ...
  // footerProps removed with the <Footer/> (2026-09 owner)
      ...
      <div style={{ maxWidth: '900px' }}>
        {active === 'templates' && (
          ...
          />
            ...
            {/* Footer removed on 2026-09 (owner): no footer on the 9
                admin/settings pages — <Footer> was the last one rendered
                here (was: <Footer {...(footerProps || {})} />). */}
          </div>
          <CookieBanner />
        </div>
      </div>
