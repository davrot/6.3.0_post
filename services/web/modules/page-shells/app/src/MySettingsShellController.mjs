  ...
  mySettingsPage: (req, res, next) => {
    void (async () => {
      ...
      res.render(mySettingsView, {
        ...locals,
        // 2026-09 (owner decision): the heading + title of this page is
        // "Account settings" (our canonical user-settings page).
        title: 'Account settings',
        userSettings,
        isMySettingsShell: true,
        upstreamSettingsUrl: '/user/mysettings',
        // 2026-09 (owner): blue-gradient nav (user settings family).
        blueNav: true,
      })
    })().catch(next)
  },
