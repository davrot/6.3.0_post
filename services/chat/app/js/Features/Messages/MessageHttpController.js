...
import * as NotificationsManager from '../Notifications/NotificationsManager.js' // [IV]: comment-activity notifications
...
async function _sendMessage(userId, projectId, content, clientThreadId, res) {
  ...
  // [IV] notifications: fire comment-activity notification batch (best-effort)
